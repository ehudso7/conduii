          ...
          <Card className="w-full max-w-md">
            ...
            <CardContent className="text-center">
              ...
              <div className="space-y-3">
                <Button asChild className="w-full" data-testid="forgot-password-back">
                ...
                <Button
                  ...
                  data-testid="forgot-password-try-different"
                >
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            ...
            <p className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <Link href="/sign-in" className="text-primary hover:underline font-medium" data-testid="forgot-password-back">
                Sign in
              </Link>
            </p>
          </CardContent>
