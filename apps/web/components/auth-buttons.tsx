...
function SimpleAuthButtons() {
  ...
  return (
    <div className="flex items-center gap-4">
      <Button variant="ghost" size="sm" onClick={nav.goToSignIn} data-testid="nav-signin">
        Sign In
      </Button>
      <Button size="sm" onClick={nav.goToSignUp} data-testid="nav-getstarted">
        Get Started
      </Button>
    </div>
  );
...
function HeroAuthButtonsInner() {
  ...
  if (isSignedIn) {
    return (
      <Button size="xl" variant="gradient" className="group" onClick={nav.goToDashboard} data-testid="hero-cta">
        Go to Dashboard
        <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition" />
      </Button>
    );
...
function CTAAuthButtonsInner() {
  ...
  if (isSignedIn) {
    return (
      <Button size="xl" variant="gradient" className="group" onClick={nav.goToDashboard} data-testid="cta-getstarted">
        Go to Dashboard
        <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition" />
      </Button>
    );
